...
CREATE TABLE IF NOT EXISTS `db_student_resource_IS`.`Classes` (
  ...
  `teachers_idUser` INT NOT NULL,
  PRIMARY KEY (`idClass`, `subjects_idSubject`, `teachers_idUser`),
  INDEX `fk_Classes_Subjects_idx` (`subjects_idSubject` ASC) ,
  INDEX `fk_Classes_Teachers1_idx` (`teachers_idUser` ASC) ,
  ...
  CONSTRAINT `fk_Classes_Teachers1`
    FOREIGN KEY (`teachers_idUser`)
    REFERENCES `db_student_resource_IS`.`Teachers` (`idUser`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
...
CREATE TABLE IF NOT EXISTS `db_student_resource_IS`.`Activities` (
  ...
  PRIMARY KEY (`idActivity`, `classes_idClass`, `Files_idFile`),
  INDEX `fk_Activities_Classes1_idx` (`classes_idClass` ASC) ,
  INDEX `fk_Activities_Files1_idx` (`Files_idFile` ASC) ,
...
CREATE TABLE IF NOT EXISTS `db_student_resource_IS`.`ci_sessions` (
  ...
  PRIMARY KEY (`ci_sessions_timestamp`))
ENGINE = InnoDB;
