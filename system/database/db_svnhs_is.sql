...
CREATE TABLE IF NOT EXISTS `db_student_resource_IS`.`Files` (
  ...
  PRIMARY KEY (`idFile`, `Activities_idActivity`),
  INDEX `fk_Files_Activities1_idx` (`Activities_idActivity` ASC) ,
  CONSTRAINT `fk_Files_Activities1`
